...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		TableColumn<Client, String> firstNameColumn = new TableColumn<>("ΟΝΟΜΑ");
		firstNameColumn.setMinWidth(95);	
		firstNameColumn.setCellValueFactory(new PropertyValueFactory<>("firstName"));
		
		//Column for the Clients Last Name
		TableColumn<Client, String> lastNameColumn = new TableColumn<>("ΕΠΙΘΕΤΟ");
		lastNameColumn.setMinWidth(95);	
		lastNameColumn.setCellValueFactory(new PropertyValueFactory<>("lastName"));
		
		//Column for the Clients father first name
		TableColumn<Client, String> fatherFirstNameColumn = new TableColumn<>("ΟΝΟΜΑ ΠΑΤΕΡΑ");
		...
		TableColumn<Client, String> addressColumn = new TableColumn<>("ΟΔΟΣ");
		addressColumn.setMinWidth(95);	
		addressColumn.setCellValueFactory(new PropertyValueFactory<>("address"));
		
		//Column for the Clients kind of Subscription
		TableColumn<Client, String> kindOfSubscriptionColumn = new TableColumn<>("ΤΥΠΟΣ ΕΓΓΡΑΦΗΣ");
		...
		TableColumn<Client, String> kindOfExerciseColumn = new TableColumn<>("ΕΙΔΟΣ ΑΣΚΗΣΗΣ");
		...
		TableColumn<Client, Integer> zipCodeColumn = new TableColumn<>("ΤΚ");
		...
		TableColumn<Client, Long> phoneNumberColumn = new TableColumn<>("ΤΗΛΕΦΩΝΟ");
		phoneNumberColumn.setMinWidth(95);	
		phoneNumberColumn.setCellValueFactory(new PropertyValueFactory<>("phoneNumber"));
		
		//Column for the Clients Birth Day
		TableColumn<Client, Integer> birthDayColumn = new TableColumn<>("ΗΜΕΡΑ ΓΕΝΝΗΣΗΣ");
		birthDayColumn.setMinWidth(115);	
		birthDayColumn.setCellValueFactory(new PropertyValueFactory<>("birthDay"));
		
		//Column for the Clients Birth Month
		TableColumn<Client, Integer> birthMonthColumn = new TableColumn<>("ΜΗΝΑΣ ΓΕΝΝΗΣΗΣ");
		...
		TableColumn<Client, Integer> birthYearColumn = new TableColumn<>("ΕΤΟΣ ΓΕΝΝΗΣΗΣ");
	...
	public ObservableList<Client> getClient(){
		...
		clients.add(new Client("Παναγιώτης","Βαρδάρης","Νικόλαος","Βασιλέως Αλκέτα 28","Φοιτητική","ΟΛΑ",67100,6944163467L, 4, 8 ,2000));
		clients.add(new Client("Αναστάσιος","Λιόντος","Δημήτριος","Ευαγόρα Παλληκαρίδη 4 ","Φοιτητική","Mai Thai",45221,6944163467L, 4, 8 ,2000));
